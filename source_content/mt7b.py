...
values = np.array([
    [16, 8, 2, 14, 12, 13, 6, 3],  # Multi-task learning
    [16, 7.5, 3, 9, 12.5, 13, 6.3, 2.8],   # Sequential Training
    [17.9, 10.5, 4, 14, 13.8, 13, 7.5, 2.5],   # Mixed Sequential Training
    [18, 11, 3.8, 16, 13.8, 13.5, 5, 3.3]   # DMT(k=1/256)
])
...
plt.title('MT-Bench Scores (7B)', size=13, pad=22,fontweight='bold')
ax.grid(True, linestyle='--', linewidth=0.5, color='grey', alpha=0.7)
plt.legend(loc='upper right', bbox_to_anchor=(1.2, 1.1))

# Save and show the plot
plt.tight_layout()
plt.savefig("mt7b.png")
