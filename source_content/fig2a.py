...
# Data
data_1 = [0.51, 0.42, 0.49, 0.49, 0.51, 0.53, 0.24, 0.44, 0.54, 0.36]
data_2 = [0.45, 0.52, 0.4, 0.49, 0.53, 0.36, 0.43, 0.53, 0.53, 0.41]
...
ax.plot(angles[1:], data_1, color='orange', linewidth=0.8, linestyle='-', marker='o',markersize=4)
# ax.fill(angles[1:], data_1, 'orange', alpha=0.1)

ax.plot(angles[1:], data_2, color='teal', linewidth=0.8, linestyle='-', marker='o',markersize=4)
...
for i, label in enumerate(categories):
    ...
    if i in [0,1,8,9]:  # Left-aligned labels
        ax.text(angle, 0.6, label, horizontalalignment='left', verticalalignment='center', fontsize=16, color='black')
    elif i in [2,7]:  # Centered labels
        ax.text(angle, 0.6, label, horizontalalignment='center', verticalalignment='center', fontsize=16, color='black')
    else:  # Left-aligned for indices 3, 4, 5
        ax.text(angle,0.6, label, horizontalalignment='right', verticalalignment='center', fontsize=16, color='black')
...
for idx, value in enumerate(yticks_values):
    ...
    fig.text(0.47+idx*0.057, 0.47, value, fontsize=18, ha='center', va='center', color='black')
