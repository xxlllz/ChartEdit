...
data1 = [0.62, 0.23, 0.16, 0.64, 0.25, 0.48, 0.2, 0.23]
data2 = [0.57, 0.32, 0.162, 0.62, 0.27, 0.58, 0.22, 0.18]
data3 = [0.57, 0.323, 0.17, 0.62, 0.26, 0.44, 0.23, 0.25]
...
plt.savefig("GPT-4_evalutator.png")
