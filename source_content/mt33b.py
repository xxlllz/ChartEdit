...
values = np.array([
    [17.7, 8, 4, 16.3, 14.5, 13.9, 6, 2],  # Multi-task learning
    [17.8,8, 3.8, 16.5, 15.3, 14.2, 8, 3.5],   # Sequential Training
    [17.9, 7.5, 5, 17, 16.5, 15, 10.5, 3],   # Mixed Sequential Training
    [18, 9, 5, 15.5, 15.3, 15, 10.5, 4]   # DMT(k=1/256)
])
...
plt.title('MT-Bench Scores (33B)', size=13, pad=22,fontweight='bold')
ax.grid(True, linestyle='--', linewidth=0.5, color='grey', alpha=0.7)
plt.legend(loc='upper right', bbox_to_anchor=(1.2, 1.1))

# Save and show the plot
plt.tight_layout()
plt.savefig("mt33b.png")
