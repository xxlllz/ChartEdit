...
# Defining the values
x = np.arange(17)
methods = ['','','','','','','OSTrack',"TransT", "TrDiMP", "STARK", "CSWinTT", "ROMTrack", "SeqTrack", "Mixformer", "ARTrack", "SUTrack"]

y_values = [0.152, 0.175, 0.19, 0.27, 0.273, 0.275, 0.288,0.293,0.300,0.303,0.304,0.318,0.319,0.325,0.336,0.348]
...
plt.title('VOT2020 Bounding-box Evaluation', fontsize=18, weight='bold')
